...
import { getPost, getAllPostSlugs } from '~/lib/recipes';
...
export const getStaticProps: GetStaticProps<RecipesPostProps, PathProps> = async ({ params }) => {
...
export default function RecipesPost({ post }: RecipesPostProps): JSX.Element {
	return (
		<>
			<Layout.Blog
				seo={{
					title: `${post.frontmatter.title} ─ recipes ─ tardito.dev`,

...
import { getPost, getAllPostSlugs } from '~/lib/trips';
...
export const getStaticProps: GetStaticProps<TripsPostProps, PathProps> = async ({ params }) => {
...
export default function TripsPost({ post }: TripsPostProps): JSX.Element {
	return (
		<>
			<Layout.Blog
				seo={{
					title: `${post.frontmatter.title} ─ trips ─ tardito.dev`,
